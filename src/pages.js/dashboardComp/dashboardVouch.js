...
function DashboardVouch({ children }) {
        ...
        <div className={classes.root}>
            <div className={classes.mainContent}>
                <div className={classes.contentNav}>
                    <div style={{ marginLeft: 80, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                        <div>
                            <Typography style={{ backgroundColor: '#fff', display: ' flex', flexDirection: 'row', alignItems: 'center', paddingLeft: '0.5rem', paddingRight: '0.5rem', height: 50, borderRadius: 10, width: '20rem', justifyContent: 'center' }}>Past</Typography>
                        </div>
                    </div>
                    <div style={{ marginLeft: 80, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                        <div>
                            <Typography style={{ backgroundColor: '#fff', display: ' flex', flexDirection: 'row', alignItems: 'center', paddingLeft: '0.5rem', paddingRight: '0.5rem', height: 50, borderRadius: 10, width: '20rem', justifyContent: 'center' }}>Current</Typography>
                        </div>
                    </div>
                    <div style={{ marginRight: 80, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                        <div>
                            <Typography style={{ backgroundColor: '#fff', display: ' flex', flexDirection: 'row', alignItems: 'center', paddingLeft: '0.5rem', paddingRight: '0.5rem', height: 50, borderRadius: 10, width: '20rem', justifyContent: 'center' }}>Saved</Typography>
                        </div>
                    </div>
                </div>
